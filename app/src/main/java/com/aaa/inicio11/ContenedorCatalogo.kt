    ...
    private fun initRecyclerCatalogo() {
        ...
        val adapter = ProductoAdapter(
            ...
            onCarritoClick = { catalogoModel ->
                ...
                Toast.makeText(this, "Comprar: ${catalogoModel.producto}", Toast.LENGTH_SHORT).show()
            },
            onComprarClick = { catalogoModel ->
                // Acción a realizar cuando se haga clic en el botón comprar
                Toast.makeText(this, "Añadido al carrito: ${catalogoModel.producto}", Toast.LENGTH_SHORT).show()
            }
        )
